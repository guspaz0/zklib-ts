...
export const USHRT_MAX: number = 65535;
export const MAX_CHUNK: number = 65472;
export const MACHINE_PREPARE_DATA_1: number = 20560;
export const MACHINE_PREPARE_DATA_2: number = 32130;
